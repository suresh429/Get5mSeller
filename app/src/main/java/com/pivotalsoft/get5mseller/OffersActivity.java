...
import com.pivotalsoft.get5mseller.Adapters.OfferAdapter;
...
public class OffersActivity extends AppCompatActivity {
    ...
    private OfferAdapter coursesAdapter;
    private List<OfferItme> coursesItemList = new ArrayList<>();
    ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        coursesAdapter = new OfferAdapter(this,coursesItemList);
        GridLayoutManager mLayoutManager1 = new GridLayoutManager(this, 1);
        recyclerCourses.setLayoutManager(mLayoutManager1);
        recyclerCourses.addItemDecoration(new GridSpacingItemDecoration(1, dpToPx(10), true));
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent add = new Intent(OffersActivity.this, AddOfferActivity.class);
                add.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_NEW_TASK);
                startActivity(add);
            }
        });
        prepareProductsData();
    ...
    private void prepareProductsData() {
        OfferItme reviewsItem = new OfferItme("Diwali Offer","DIWALI","18","oct");
        coursesItemList.add(reviewsItem);

        reviewsItem =  new OfferItme("Dussehra Offer","DUSS100","28","nov");
        coursesItemList.add(reviewsItem);

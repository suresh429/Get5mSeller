...
import com.pivotalsoft.get5mseller.ProductsActivities.ProductsDetailsActivity;
...
public class ProductsListAdapter extends RecyclerView.Adapter<ProductsListAdapter.MyViewHolder> {
    ...
    private List<ProductsListItem> productsItemList;
    ...
    public ProductsListAdapter(List<ProductsListItem> productsItemList, Context mContext) {
    ...
    @Override
    public void onBindViewHolder(ProductsListAdapter.MyViewHolder holder, final int position) {
        ProductsListItem productsItem = productsItemList.get(position);
        ...
        holder.productsLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent4 =new Intent(mContext,ProductsDetailsActivity.class);
